...
extension SmartScalerExtension on num {
  ...
  double get ph => _OrkittScreenUtils.percentHeight(toDouble());

  /// Percent of screen width
  double get pw => _OrkittScreenUtils.percentWidth(toDouble());

  /// Responsive radius from percent width
  double get pr => _OrkittScreenUtils.percentRadius(toDouble());

  /// Responsive font size based on pixelRatio and aspectRatio
  double get psp => _OrkittScreenUtils.percentFontSize(toDouble());
  ...
  double get dw => _safe(() => _DesignScaleUtils.instance.scaleWidth(this));

  /// Design-mode responsive height
  double get dh => _safe(() => _DesignScaleUtils.instance.scaleHeight(this));

  /// Design-mode responsive font size
  double get dt => _safe(() => _DesignScaleUtils.instance.scaleFont(this));

  /// Design-mode responsive radius
  double get dr => _safe(() => _DesignScaleUtils.instance.scaleRadius(this));
...
class UIContext {
  ...
  static double get width => _OrkittScreenUtils.width;

  /// Returns the current screen height.
  static double get height => _OrkittScreenUtils.height;

  /// Returns the current safe width (excluding system UI).
  static double get safeWidth => _OrkittScreenUtils.safeWidth;

  /// Returns the current safe height (excluding system UI).
  static double get safeHeight => _OrkittScreenUtils.safeHeight;

  /// Returns the current pixel ratio.
  static double get pixelRatio => _OrkittScreenUtils.pixelRatio;

  /// Returns the current aspect ratio.
  static double get aspectRatio => _OrkittScreenUtils.aspectRatio;

  static Orientation get orientation => _OrkittScreenUtils.orientation;
  ...
  static ScreenType get deviceType => _OrkittScreenUtils.screenType;
  static OSType get osType => _OrkittScreenUtils.osType;
