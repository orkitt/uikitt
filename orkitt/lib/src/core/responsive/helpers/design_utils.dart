...
///
/// Call [_DesignScaleUtils.instance.init] once, preferably in your root widget tree.
class _DesignScaleUtils {
  static final _DesignScaleUtils _instance = _DesignScaleUtils._internal();

  factory _DesignScaleUtils() => _instance;
  static _DesignScaleUtils get instance => _instance;

  _DesignScaleUtils._internal();
