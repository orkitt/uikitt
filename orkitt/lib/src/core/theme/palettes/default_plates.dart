...
/// ==============================
class NeutralLightColors extends BrandKolors {
  ...
  @override
  Color get primary => const Color(0xFF6B7280);
  @override
  Color get secondary => const Color(0xFF9CA3AF);
  @override
  Color get accent => const Color(0xFFD1D5DB);
...
/// ==============================
class NeutralDarkColors extends BrandKolors {
  ...
  @override
  Color get primary => const Color(0xFF9CA3AF);
  @override
  Color get secondary => const Color(0xFF6B7280);
  @override
  Color get accent => const Color(0xFF4B5563);
